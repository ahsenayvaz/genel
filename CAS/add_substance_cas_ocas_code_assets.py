...
csv_file_cas = "add_substance_cas_ocas_code.csv"   #
...
@asset(
    ...
    description=f"Imports additional CAS/OCAS Codes from '{csv_file_cas}' into '{mapping_table_substances}'.",
        ...
        with csv_path.open(
            ...
            for row in reader:
                ...
                if action_import == "add_cas_code":
                    ...
                    new_cas_medikation = (
                        found_cas if found_cas else current_ocas_primary
                    )
                ...
                # ==============================================================
                    ...
                    if not found_ocas:
                        context.log.warning(
                            f"ASK {ask}: action_import is add_ocas_code, but found_ocas_code is empty. Skipping."
                        )
                        continue
                    ...
                    new_cas_medikation = (
                        current_cas if current_cas else new_ocas_primary
                    )
