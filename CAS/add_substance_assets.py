...
csv_file_cas = "add_substance.csv"   #
...
@asset(
    key="medication_ingredient_substance_import",
    description=(
...
def medication_ingredient_substance_import(context: AssetExecutionContext) -> None:
    """
    ...
    try:
        ...
        with csv_path.open(
            ...
            for row in reader:
                ...
                cas_medikation = (
                    found_cas if found_cas else ocas_code_primary
                )
